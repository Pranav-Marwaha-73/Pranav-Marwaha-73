# 💫 About Me:
👋 Hi, I'm Pranav Marwaha<br>I'm a dedicated and aspiring Data Scientist and Software Developer currently pursuing a B.Tech in Computer Science Engineering. I’m passionate about solving real-world problems using machine learning, artificial intelligence, and creative software solutions.<br><br>🔬 I’ve interned in AI/ML and Web Development, where I worked on everything from data cleaning and visualization to building interactive UIs with Streamlit and responsive websites using HTML, CSS, and JavaScript.<br><br>💡 My projects include:<br><br>Medibot with RAG – A multilingual AI chatbot using vector databases, Hugging Face models, and Groq Vision.<br><br>Stock Market Price Predictor – Built using LSTM neural networks with a Streamlit interface.<br><br>Friday AI – A voice-enabled assistant powered by Gemini API and prompt engineering.<br><br>Software Developer Salary Prediction – A data-driven insight project.<br><br>📊 I’m skilled in Python, TensorFlow, Keras, Power BI, Excel, data visualization, supervised/unsupervised learning, and prompt engineering.<br><br>📚 I’m always learning and have earned certifications from NVIDIA, Microsoft, Infosys Springboard, and Unstop.
